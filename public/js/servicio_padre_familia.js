...
let registrar_preferncia = (pidentificacion, ppreferencia) => {
    let request = $.ajax({
      url: "http://localhost:4000/api/registrar_preferncia",
      method: "POST",
      data: {
        identificacion: pidentificacion,
    ...
    request.done(function (msg) {
      console.log('preferencia agregada correctamente');
    });
