...
let mostrar_mensualidad = () => {
    let filtro = input_filtrar.value;
    select_criterios.value = 'Mensualidad';
    document.getElementById('lista_instituciones').innerHTML = '';
    let opciones_cantidad = '<select> <option value=50,000-100,000>50,000 - 100,000 Colones</option>'
    if (cantidades == cantidad.addEventListener('click', opciones_cantidad)) {
